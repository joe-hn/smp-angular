...
export class ReporteObjetoGastoComponent implements OnInit {
  ...
  modeloComponente: reporteObjetoGasto[];
  modeloObjetoGasto: reporteObjetoGasto[];
  modeloOperacion: reporteObjetoGasto[];
  ...
  onGenerarReporte() {
    this.apireporte
      .GetReporteObjetoGastoComponente(this.filtro)
      .subscribe((res) => {
        this.modeloComponente = res.modelo;        

        this.apireporte.GetReporteObjetoGasto(this.filtro).subscribe((res) => {
          this.modeloObjetoGasto = res.modelo;          

          this.apireporte
            .GetReporteObjetoGastoOperacion(this.filtro)
            .subscribe((res) => {
  ...
  onReporte() {
    ...
    var nombre =
      "Grupo por Gasto - fecha generacion " +
