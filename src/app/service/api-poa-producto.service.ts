...
export class ApiPoaProductoService {
  url: string = _global.url + 'poaproducto/';
  ...
  GetIndicador(id): Observable<any> {    
    return this.http.get(this.url + 'indicador/' + id, this.httpOptions).pipe(map(this.extractData));
  }
